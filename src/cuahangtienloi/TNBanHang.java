...
public class TNBanHang extends javax.swing.JFrame {
    ...
    public TNBanHang() {
        ...
        tbBanHang.getColumnModel().getColumn(0).setPreferredWidth(100);
        ...
        tbHoaDon.getColumnModel().getColumn(2).setPreferredWidth(250);
        tbHoaDon.getColumnModel().getColumn(4).setPreferredWidth(200);
        ...
        tbTraCuu.getColumnModel().getColumn(0).setPreferredWidth(220);
...
//            int i=0; 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            int flagtt = 1;//Kiểm tra xem thành viên có tồn tại ko?
